// backend/src/db/models/inventarioItem.js
...
stock_minimo: { type: DataTypes.DECIMAL(14,3), allowNull: false, defaultValue: '0' },
activo: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: true },
meta: { type: DataTypes.JSONB, allowNull: false, defaultValue: {} }
}, { tableName: 'inventario_items', timestamps: true, createdAt: 'created_at', updatedAt: 'updated_at' });
