...
ajustes: { type: DataTypes.JSONB, allowNull: false, defaultValue: [] }, // [{tipo:'Adelanto'|'Retención'|'Abono'|'Otro', monto: -10, motivo:'...'}]
...
}, { tableName: 'nomina_detalles', timestamps: true, createdAt: 'created_at', updatedAt: 'updated_at', indexes: [{ fields: ['nomina_id','trabajador_id'] }] });
