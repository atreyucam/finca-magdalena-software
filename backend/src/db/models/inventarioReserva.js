// backend/src/db/models/inventarioReserva.js
...
module.exports = (sequelize) => {
  const InventarioReserva = sequelize.define('InventarioReserva', {
    ...
    cantidad_en_base: { type: DataTypes.DECIMAL(14,3), allowNull: false }, // normalizada a unidad base del item
    ...
    indexes: [
      ...
      { unique: false, fields: ['tarea_id','item_id','estado'] }
    ]
  });
