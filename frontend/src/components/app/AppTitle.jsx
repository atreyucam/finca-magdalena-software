...
const TITLES = [
  ...
  { match: /^\/owner\/compras\/?$/, title: "Compras" },
  { match: /^\/owner\/compras\/nueva\/?$/, title: "Nueva Compra" },
  { match: /^\/owner\/compras\/\d+\/?$/, title: "Detalle de Compra" },
  { match: /^\/owner\/ventas\/?$/, title: "Ventas" },
  { match: /^\/owner\/ventas\/clientes\/?$/, title: "Clientes de Ventas" },
  { match: /^\/owner\/ventas\/clientes\/\d+\/?$/, title: "Detalle de Cliente" },
  ...
  { match: /^\/tech\/ventas\/?$/, title: "Ventas" },
  { match: /^\/tech\/ventas\/clientes\/?$/, title: "Clientes de Ventas" },
  { match: /^\/tech\/ventas\/clientes\/\d+\/?$/, title: "Detalle de Cliente" },
